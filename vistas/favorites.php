...
<nav class="n">
  <div class="nc">
    ...
    <div class="ni">
      <a href="/vistas/cart.php" class="ic" id="cartico" title="Carrito">
      ...
      <a href="/vistas/favorites.php" class="ic active" id="fvic" title="Favoritos">
...
<section class="h">
  <div class="hc">
    <h1 class="ht">Mis Favoritos</h1>
    <p class="hs">Items guardados para más tarde</p>
  </div>
</section>
...
<main class="c">
  <section class="fvs">
    <div class="ef" id="emptyFav">
      <p>No tienes items favoritos aún</p>
      <a href="/vistas/catalogo.php" class="b bp">Explorar Catálogo</a>
    </div>
    <div class="fvg" id="favGrid" style="display: none;"></div>
  </section>
</main>
